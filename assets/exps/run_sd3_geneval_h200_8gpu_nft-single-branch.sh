...
SAVE_DIR="${REPO_DIR}/outputs/nft_sd3_geneval_nft_single_branch-adapt-clean-old-KL1e-4"
RUN_NAME="sd35_geneval_h200_8gpu_nft_single_branch-adapt-clean-old-KL1e-4"
...
torchrun --standalone --nnodes=1 --nproc_per_node="${NPROC_PER_NODE}" scripts/train_nft_sd3_single-branch-ada-clean-old.py \
