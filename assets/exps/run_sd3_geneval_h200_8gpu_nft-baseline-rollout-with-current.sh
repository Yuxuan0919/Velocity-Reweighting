...
SAVE_DIR="${REPO_DIR}/outputs/nft_sd3_geneval_nft_baseline-adapt-KL1e-4-rollout-with-current"
RUN_NAME="sd35_geneval_h200_8gpu_nft_baseline-adapt-KL1e-4-rollout-with-current"
...
torchrun --standalone --nnodes=1 --nproc_per_node="${NPROC_PER_NODE}" scripts/train_nft_sd3_origin-rollout-with-current.py \
