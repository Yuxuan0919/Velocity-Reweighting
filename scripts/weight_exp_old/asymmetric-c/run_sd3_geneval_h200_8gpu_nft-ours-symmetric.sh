...
SAVE_DIR="${SAVE_DIR:-${REPO_DIR}/outputs/nft_sd3_geneval_h200_8gpu_nft_ours-symmetric-${ASYMMETRIC_SCALE_TAG}-KL1e-4-beta1.0-fixshift}"
RUN_NAME="${RUN_NAME:-sd35_geneval_h200_8gpu_nft_ours-symmetric-${ASYMMETRIC_SCALE_TAG}-KL1e-4-beta1.0-fixshift}"
...
torchrun --standalone --nnodes=1 --nproc_per_node="${NPROC_PER_NODE}" scripts/train_nft_sd3_ours_symmetric_scaling.py \
