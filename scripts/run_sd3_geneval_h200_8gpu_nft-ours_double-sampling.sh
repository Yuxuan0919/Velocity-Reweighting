...
SAVE_DIR="${REPO_DIR}/outputs/nft_sd3_geneval_nft_ours-KL1e-4-double-sampling-fixv-lr1e-4"
RUN_NAME="sd35_geneval_h200_8gpu_nft_ours-KL1e-4-onlyt-double-sampling-fixv-lr1e-4"
