...
BETA_A="${BETA_A:-1}"
BETA_D="${BETA_D:-1}"
SAVE_DIR="${REPO_DIR}/outputs/nft_sd3_geneval_ad_unnormalized_betaa${BETA_A}_betad${BETA_D}"
RUN_NAME="sd35_geneval_h200_8gpu_ad_unnormalized_betaa${BETA_A}_betad${BETA_D}"
...
torchrun --standalone --nnodes=1 --nproc_per_node="${NPROC_PER_NODE}" scripts/train_nft_sd3_ad_unnormalized.py \
