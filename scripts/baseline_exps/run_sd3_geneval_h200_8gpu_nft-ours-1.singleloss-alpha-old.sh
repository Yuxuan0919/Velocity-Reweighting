...
TRAIN_SCRIPT="scripts/baseline_exps/train_nft_sd3_ours-1.singleloss-alpha-old.py"

LOGDIR="${LOGDIR:-${REPO_DIR}/logs/baseline_exps}"
SAVE_DIR="${SAVE_DIR:-${REPO_DIR}/outputs/baseline_exps/nft_sd3_geneval_h200_8gpu_nft_ours-1singleloss-xpred-alpha-old-KL1e-4-beta1.0}"
RUN_NAME="${RUN_NAME:-sd35_geneval_h200_8gpu_nft_ours-1singleloss-xpred-alpha-old-KL1e-4-beta1.0}"
...
echo "Launching H200 8-GPU single-loss x-prediction experiment with alpha from the old policy"
