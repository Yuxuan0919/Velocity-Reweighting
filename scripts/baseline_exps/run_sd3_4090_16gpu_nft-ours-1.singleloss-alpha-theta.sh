...
SAVE_DIR="${SAVE_DIR:-${REPO_DIR}/outputs/baseline_exps/nft_sd3_geneval_4090_${WORLD_SIZE}gpu_nft_ours-1singleloss-xpred-alpha-theta-KL1e-4-beta1.0-fulltime}"
RUN_NAME="${RUN_NAME:-sd35_geneval_4090_${WORLD_SIZE}gpu_nft_ours-1singleloss-xpred-alpha-theta-KL1e-4-beta1.0-fulltime}"
