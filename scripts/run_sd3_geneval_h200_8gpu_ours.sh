...
SAVE_DIR="${REPO_DIR}/outputs/nft_sd3_geneval_ours"
RUN_NAME="sd35_geneval_h200_8gpu_ours"
...
torchrun --standalone --nnodes=1 --nproc_per_node="${NPROC_PER_NODE}" scripts/train_nft_sd3.py \
