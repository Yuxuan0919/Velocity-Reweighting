...
SAVE_DIR="${REPO_DIR}/outputs/nft_sd3_geneval_nft_ours-weight-e-reward-rms-KL1e-4"
RUN_NAME="sd35_geneval_h200_8gpu_nft_ours-weight-e-reward-rms-KL1e-4"
...
torchrun --standalone --nnodes=1 --nproc_per_node="${NPROC_PER_NODE}" scripts/weight_exps/train_nft_sd3_ours_weight_e_reward_rms.py \
