...
SAVE_DIR="${REPO_DIR}/outputs/nft_sd3_geneval_nft_ours-group-quantile-KL1e-4-beta1.0-max0.95-min0.05"
RUN_NAME="sd35_geneval_h200_8gpu_nft_ours-group-quantile-KL1e-4-beta1.0-max0.95-min0.05"
...
torchrun --standalone --nnodes=1 --nproc_per_node="${NPROC_PER_NODE}" scripts/train_nft_sd3_group_quality_adaptive_quantile.py \
  ...
  --config.train.quality_adaptive_quantile_min=0.05 \
  --config.train.quality_adaptive_quantile_max=0.95
