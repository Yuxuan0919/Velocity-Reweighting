...
SAVE_DIR="${SAVE_DIR:-${REPO_DIR}/outputs/weight_exps/fix_tie_group/sd35_geneval_h200_8gpu_nft_ours-4selection-tie-aware-${EXPERIMENT_TAG}-KL1e-4-beta${EXPERIMENT_BETA}-fulltime}"
RUN_NAME="${RUN_NAME:-sd35_geneval_h200_8gpu_nft_ours-4selection-tie-aware-${EXPERIMENT_TAG}-KL1e-4-beta${EXPERIMENT_BETA}-fulltime}"
