...
SAVE_DIR="${SAVE_DIR:-${REPO_DIR}/outputs/sd35_pickscore_4090_${WORLD_SIZE}gpu_nft_baseline-KL1e-4-beta1.0}"
RUN_NAME="${RUN_NAME:-sd35_pickscore_4090_${WORLD_SIZE}gpu_nft_baseline-KL1e-4-beta1.0}"
