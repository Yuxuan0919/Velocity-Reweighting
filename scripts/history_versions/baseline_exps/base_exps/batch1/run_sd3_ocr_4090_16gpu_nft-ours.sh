...
SAVE_DIR="${SAVE_DIR:-${REPO_DIR}/outputs/sd35_ocr_4090_${WORLD_SIZE}gpu_nft_ours-KL1e-4-beta1.0}"
RUN_NAME="${RUN_NAME:-sd35_ocr_4090_${WORLD_SIZE}gpu_nft_ours-KL1e-4-beta1.0}"
