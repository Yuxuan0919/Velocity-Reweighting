...
SAVE_DIR="${REPO_DIR}/outputs/baseline_exps/sd35_geneval_nft_baseline-Aequality*2-KL1e-4-beta1.0-fulltime-1"
RUN_NAME="sd35_geneval_h200_8gpu_nft_baseline-Aequality*2-KL1e-4-beta1.0-fulltime-1"
