...
TRAIN_SCRIPT="scripts/alpha_exps/train_nft_sd3_ours-1.singleloss-alpha.py"
...
RUN_NAME="${RUN_NAME:-sd35_pickscore_nft_ours-1singleloss-xpred-alpha-theta-KL1e-4-beta1.0-fulltime_r${RUN_INDEX}_${GPU_TYPE}}"
