...
RUN_NAME="${RUN_NAME:-sd35_geneval_nft_ours-alpha-old-KL1e-4-beta1.0-fulltime_r${RUN_INDEX}_${GPU_TYPE}}"
...
torchrun "${TORCHRUN_DISTRIBUTED_ARGS[@]}" --nproc_per_node="${NPROC_PER_NODE}" scripts/alpha_exps/train_nft_sd3_ours.py \
