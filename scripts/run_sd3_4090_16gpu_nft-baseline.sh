...
SAVE_DIR="${SAVE_DIR:-${REPO_DIR}/outputs/baseline_exps/sd35_pickscore_4090_${WORLD_SIZE}gpu_nft_baseline-KL1e-4-beta1.0-fulltime}"
RUN_NAME="${RUN_NAME:-sd35_geneval_4090_${WORLD_SIZE}gpu_nft_baseline-KL1e-4-beta1.0-fulltime}"
