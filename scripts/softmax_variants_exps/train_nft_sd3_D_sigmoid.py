...
# Experiment D: sigmoid; formulas and sweep are in assets/softmax_variant/variants.tex.
WEIGHT_VARIANT = "D"
flags.DEFINE_float("weight_c", 0.01, "Near-max fraction or mapping temperature c (A/B/D/F).")
