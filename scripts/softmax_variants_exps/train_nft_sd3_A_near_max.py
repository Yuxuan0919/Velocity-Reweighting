...
# Experiment A: near_max; formulas and sweep are in assets/softmax_variant/variants.tex.
WEIGHT_VARIANT = "A"
flags.DEFINE_float("weight_c", 0.0, "Near-max fraction or mapping temperature c (A/B/D/F).")
