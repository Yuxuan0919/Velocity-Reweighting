...
# Experiment C: linear; formulas and sweep are in assets/softmax_variant/variants.tex.
WEIGHT_VARIANT = "C"
flags.DEFINE_float("weight_c", 1.0, "Near-max fraction or mapping temperature c (A/B/D/F).")
